...
const restockInDays = Math.floor(Math.random() * 8) + 3;
  ...
  const fetchAllWomenProducts = async () => {
    const categories = [
      "womens-bags",
      "womens-dresses",
      "womens-jewellery",
 ...
 if (isLoading) {
  ...
  return (
    <div className="p-16 bg-cream">
      <h1 className="font-bold text-2xl sm:text-3xl mb-6 text-oranges font-marker text-center">Women Products</h1>
