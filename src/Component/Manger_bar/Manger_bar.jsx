...
export default function  Manger_bar({ isOpen, toggleManbar  }) {
    ...
    <>
      ...
      >
        ...
        <div className="flex items-center justify-between px-5 py-4 border-b border-white/10 bg-oranges">
          <span className="text-2xl font-bold tracking-wider font-marker  text-primary">Manger Panel</span>
          <button
            onClick={toggleManbar }
        ...
        <nav className="mt-6 px-4 space-y-3 overflow-y-auto  h-[calc(100vh-80px)]">
          <NavItem to="/manger_dashboard" icon={<FaUserCog />} label="Dashboard" className="text-primary" />
          <NavItem to="/manger_dashboard/manger_man" icon={<FaUserCog />} label="Users" />
          <NavItem to="/manger_dashboard/add_users" icon={<FaUserCog />} label="Add Users" />
          <NavItem to="/manger_dashboard/product_man" icon={<FaBox />} label="Add Products" />
          <NavItem to="/manger_dashboard/delete_Product" icon={<FaBox />} label="Delete Products" />
          <NavItem to="/manger_dashboard/update_Product" icon={<FaBox />} label="Update Products" />
